    ...
    return <div className='single__nft__card'>
        <div className='nft__img'>
          ...
          <div className='nft__content'>
            ...
            <div className='creator__info-wrapper d-flex align-items-center'>
                <div className='creator__img'>
                    <img src={creatorImg} alt="img" className='w-100'/>
                </div>
            ...
            <div className=' mt-3 d-flex align-items-center justify-content-between'>
                <button className="bid__btn d-flex align-items-center gap-2">
                    <i className="ri-shopping-bag-line"></i> Place Bid</button>
